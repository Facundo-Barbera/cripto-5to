# DNSSEC Analysis Report: uatlaxcala.edu.mx

**Analysis Date:** 2025-12-01T10:07:03.465618
...
|------|--------|----|----- |--------|
| uatlaxcala.edu.mx | No | No | No | Unsigned |
| edu.mx | Yes | Yes | Yes | Signed |
| mx | Yes | Yes | Yes | Signed |
| . | Yes | N/A | Yes | Signed (Root) |

**Chain Status:** Broken at `uatlaxcala.edu.mx`
