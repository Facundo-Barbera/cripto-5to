# DNSSEC Analysis Report: upmich.edu.mx

**Analysis Date:** 2025-12-01T10:11:06.116466
...
|------|--------|----|----- |--------|
| upmich.edu.mx | No | No | No | Unsigned |
| edu.mx | Yes | Yes | Yes | Signed |
| mx | Yes | Yes | Yes | Signed |
| . | Yes | N/A | Yes | Signed (Root) |

**Chain Status:** Broken at `upmich.edu.mx`
