# DNSSEC Analysis Report: ufrontera.edu.mx

**Analysis Date:** 2025-12-01T10:10:06.287122
...
|------|--------|----|----- |--------|
| ufrontera.edu.mx | No | No | No | Unsigned |
| edu.mx | Yes | Yes | Yes | Signed |
| mx | Yes | Yes | Yes | Signed |
| . | Yes | N/A | Yes | Signed (Root) |

**Chain Status:** Broken at `ufrontera.edu.mx`
