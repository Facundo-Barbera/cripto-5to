...
Particip\'e en la integraci\'on del an\'alisis, construcci\'on de m\'etricas y revisi\'on del cumplimiento RFC. Aprend\'i a interpretar errores criptogr\'aficos y la importancia del DS.

\medskip
\textbf{Valeria Garc\'ia Hern\'andez}\\
Realic\'e las consultas DNSSEC y validaci\'on con herramientas CLI. Comprend\'i c\'omo validar una cadena completa y por qu\'e NSEC3 protege de enumeraci\'on.

\medskip
\textbf{Facundo Bautista Barbera}\\
Automatizaci\'on del pipeline y del procesamiento del JSON. Profundic\'e en Python dnspython y en c\'omo detectar fallos criptogr\'aficos de manera reproducible.

\medskip
\textbf{Emiliano Ruiz L\'opez}\\
Evalu\'e algoritmos y tama\~nos de clave. Entend\'i por qu\'e algoritmos modernos como ED25519 ofrecen ventajas significativas.

\medskip
\textbf{Daniel Garnelo Mart\'inez}\\
Redact\'e la secci\'on de buenas pr\'acticas y an\'alisis de riesgos. Aprend\'i a interpretar RFCs y alinear configuraciones DNSSEC con est\'andares actuales.
